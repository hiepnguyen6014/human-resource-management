                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" data-bs-toggle="tab"
                                        ...
                                        aria-controls="profile-details" aria-selected="true">Thông tin tài
                                        khoản</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                            ...
                                            <div class="pt-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="date" class="form-control"
                                                        id="view-profile-modal-birthday" name="birthday">
                                                </div>
                                            </div>
                                            <div class="pt-3">
                                                <label>Email</label>
                                                <div class="input-group">
                                                    <input type="text" class="form-control"
                                                        id="view-profile-modal-email" name="email">
                                                </div>
                                            </div>
                                            <div class="pt-3">
                                                <label>Salary</label>
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        id="view-profile-modal-salary" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="pt-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control"
                                                        id="view-profile-modal-lastname" name="fname">
                                                </div>
                                            </div>
                                            <div class="pt-3">
                                            ...
                                            <div class="pt-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control"
                                                        id="view-profile-modal-phone" name="phone">
                                                </div>
                                            </div>
                                            <div class="pt-3">
                                                <label>Chức vụ</label>
                                                <div class="input-group">
                                                    <input type="text" class="form-control"
                                                        id="view-profile-modal-position" disabled>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col pb-3">
                                            <div class="pt-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control"
                                                        id="view-profile-modal-address" name="address">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="pb-3">
                                            <button onclick="updateProfile()"
                                                class="float-end btn btn-outline-primary">Cập nhập</button>
                                        </div>
                                    </form>
                                </div>
                                    ...
                                    <form onsubmit="return false" class="row" id="form-change-password">
                                        ...
                                        <div class="col-md-6 py-5">
                                            ...
                                            <div class="pt-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="password" class="form-control view-profile-modal-new-password"
                                        ...
                                        <div class="pb-3">
                                            <button onclick="changePassword()"
                                                class="float-end btn btn-outline-primary" id="btn-change-password">Cập nhập</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
