                    ...
                    <div class="row">
                        <div class="col-lg-4 col-12 border-end">
                            <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                                ...
                                <span class="font-weight-bold fz-24" id="view-profile-modal-fullname"></span>
                                <span class="text-black-50" id="view-profile-modal-email"></span>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="pt-3">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="view-profile-modal-firstname">
                                        </div>
                                    </div>
                                    <div class="pt-3">
                                        <label>Birthday</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="view-profile-modal-birthday" disabled>
                                        </div>
                                    </div>
                                    <div class="pt-3">
                                        <label>Office</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="view-profile-modal-office" disabled>
                                        </div>
                                    </div>
                                    <div class="pt-3">
                                        <label>Salary</label>
                                    ...
                                    <div class="pt-3">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="view-profile-modal-username"
                                                disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    ...
                                    <div class="pt-3">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="view-profile-modal-join" disabled>
                                        </div>
                                    </div>
                                    <div class="pt-3">
                                        <label>Phone</label>
