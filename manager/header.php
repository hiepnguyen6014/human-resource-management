        ...
        <nav class="navbar-dark custom-navbar">
            ...
            <ul class="navbar-nav">
                ...
                <div class="collapse" id="feature">
                    <li>
                        <a onclick="switchPageManager('staff-manager')" class="nav-link nav-link-custom p-3 text-white">
                            <span class="me-2"><i class="fas fa-user-cog"></i></span>
                            <span>Staff</span>
                        </a>
                    </li>
                    <li style="position: relative;">
                        <a onclick="switchPageManager('vacation-request')" class="nav-link nav-link-custom p-3 text-white">
                            <span class="me-2">
